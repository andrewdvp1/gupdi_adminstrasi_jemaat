...
function onSearch() {
    ...
    debounceTimer = setTimeout(() => {
        router.get(route('pernikahan.index'), {
...
function filterTahun() {
    router.get(route('pernikahan.index'), { tahun: tahunFilter.value, search: searchKeyword.value }, { preserveState: true });
}
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 p-4 border-b border-gray-100">
                <div class="flex items-center gap-2">
                    ...
                    <input
                        ...
                        @input="onSearch"
                        placeholder="Cari nama pria, wanita, nomor surat..."
